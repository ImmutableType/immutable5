...
const CreateProfilePage: React.FC = () => {
  ...
  if (!selectedAuth) {
    return (
      <div className="profile-container profile-centered">
        <div className="profile-card">
          <h1 className="profile-title">Create Your Identity Profile</h1>
          <p className="profile-subtitle">
            Establish your verified digital identity on Flow EVM with our secure, transferable identity system
          </p>
          ...
          {hasMetaMask ? (
            ...
            >
              ...
              <div>
                <div className="btn-text-main">Connect with MetaMask</div>
                <div className="btn-text-sub">Tier 0 • Basic Identity Verification</div>
              </div>
            </button>
          ) : (
            <div>
